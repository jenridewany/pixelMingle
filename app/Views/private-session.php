...
<head>
  ...
  <title>PORTRAIT | AVN PROJECT</title>
...
<body>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown"> 
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="#">PRIVATE SESSION</a>
  ...
  <section class="hero">
    <div class="image-container">
      <img src="assets/hero-single.jpg" alt="Hero Image">
    </div>
    <div class="hero-content">
      <h1>"PORTRAIT"</h1>
      <hr>
      <P>SOULFUL GAZE, TIMELESS MEMORIES CAPTURED.</P>
    </div>
  </section>
  ...
  <section class="gallery-black">
    <div class="image-container">
      <div class="image-wrapper">
        <img src="assets/priv-ses-jj2.png" alt="Image 1">
        <div class="description">
          <h3>PORTRAIT OF JEJE</h3>
          <P>TUGU, JOGJA</P>
        </div>
      </div>
      <div class="image-wrapper">
        <img src="assets/priv-ses-2.png" alt="Image 2">
        <div class="description">
          <h3>PORTRAIT OF JANE</h3>
          <P>FOR ACNE STUDIO</P></div>
      </div>
      <div class="image-wrapper">
        <img src="assets/priv-ses-3.png" alt="Image 1">
        <div class="description">
          <h3>ON ANALOG</h3>
          <P>RORY, TABANAN, BALI</P>
        </div>
      </div>
      <div class="image-wrapper">
        <img src="assets/priv-ses-4.png" alt="Image 2">
        <div class="description">
          <h3>ON THE WATER</h3>
          <P>RAIA, BEDUGUL, BALI</P></div>
      </div>
    </div>
  </section>
